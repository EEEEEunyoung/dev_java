...
import dev_java.Semi.login.oracle.DBCon;
import dev_java.Semi.login.oracle.DbFunction;

public class RegisterCopy extends JFrame implements ActionListener {
  // 선언부
  ...
  public static void main(String[] args) {
    RegisterCopy rs = new RegisterCopy();
    rs.initDisplay();
  }
