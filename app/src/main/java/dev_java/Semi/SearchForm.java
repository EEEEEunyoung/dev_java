...
public class SearchForm extends JFrame implements ActionListener {
  ...
  public void initDisplay() {
    ...
    cPanel.setBounds(0, 95, 426, 380);
    cPanel.setBackground(new Color(0, 0, 0, 0));

    ///// 버튼
    jbtn_friend.setBounds(10, 565, 80, 80);
    this.add(jbtn_friend);
    jbtn_search.setBounds(100, 565, 80, 80);
    this.add(jbtn_search);
    jbtn_home.setBounds(200, 565, 80, 80);
    this.add(jbtn_home);
    jbtn_setting.setBounds(290, 565, 80, 80);
